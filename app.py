...
WALKTHROUGH_SLIDES = [
    ...
    WalkthroughSlide(
        ...
        "Help Brooke picture families arriving, kids settling, teens contributing, parents breathing, and the day ending with visible evidence of growth.",
    ...
    WalkthroughSlide(
        ...
        "A strong walkthrough should turn excitement into clear decisions: launch shape, naming, age scope, cafe stance, partnership timing, and interest page readiness.",
...
OWNER_INPUT_ITEMS = [
    OwnerInputItem(
        ...
        "The current site can explain the need, but the personal why, timeline, and emotional details need Brooke's words.",
...
OWNER_REVIEW_PREP_ITEMS = [
    ...
    OwnerReviewPrepItem(
        ...
        "Open the input packet and printable worksheet before asking for decisions.",
...
OWNER_MEETING_SCRIPT = [
    OwnerMeetingScriptStep(
        ...
        "Brooke, this is the private version of Cultivate before the world sees it. The goal is to let the full vision feel real and decide what is safe to show families first.",
        "owner_review_prep",
    ...
    OwnerMeetingScriptStep(
        ...
        "owner_walkthrough",
        "Watch for the language Brooke repeats, sharpens, or corrects.",
        "Do not over-explain every room before the concept has landed.",
    ),
    OwnerMeetingScriptStep(
        "7-10 min",
    ...
    OwnerMeetingScriptStep(
        ...
        "what_cultivate_is",
        "Mark any boundary she wants to revise.",
...
OWNER_REVIEW_PACKET_ITEMS = [
    ...
    OwnerReviewPacketItem(
        ...
        "Confidence, questions, and first reactions.",
        "owner_walkthrough",
    ),
    OwnerReviewPacketItem(
        "During",
        "Owner Input Packet",
        "Ask the questions that unblock public copy.",
    ...
    OwnerReviewPacketItem(
        "After",
        "Next Actions",
        "Turn answers into concrete artifacts and work queues.",
...
REVIEW_SURFACES = [
    ...
    ReviewSurface(
        ...
        "What needs Brooke's judgment next?",
        "owner_input_packet",
    ),
    ReviewSurface(
        "Planning",
        "Owner Review Worksheet",
        "You want a printable note-taking surface for the review conversation.",
    ...
    ReviewSurface(
        "Planning",
        "Owner Answer Log",
        "You need a durable ledger of approved answers before changing public drafts.",
    ...
    ReviewSurface(
        "Planning",
        "Post-Meeting Update Plan",
        "You need a safe order for converting answers into repo changes.",
    ...
    ReviewSurface(
        "Planning",
        "Owner Review Prep",
        "You want the review to feel polished before Brooke sees the site.",
    ...
    ReviewSurface(
        ...
        "What was approved, held, revised, or sent to validation?",
        "owner_meeting_recap",
    ),
    ReviewSurface(
        "Safety",
